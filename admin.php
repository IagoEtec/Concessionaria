<?php
// admin.php (ATUALIZADO - SEM IDIOMAS)
require 'db.php';
require 'config.php';
...
<head>
<meta charset="utf-8" />
<title>Admin - Select Car Motors</title>
...
<main class="container">
  ...
  <div class="admin-form-container">
    <form action="add_car.php" method="post" class="admin-form">
      ...
      <div class="form-grid">
        <input type="text" name="titulo" placeholder="Título do carro" required>
        <input type="text" name="descricao" placeholder="Descrição do carro" required>
        <input type="text" name="imagem" placeholder="Nome da imagem (ex: car6.jpg)" required>
      </div>
          ...
          <?php foreach($carros as $c): ?>
            <tr>
              ...
              <td style="white-space: nowrap;">
                <a href="edit_car.php?id=<?= $c['idcar'] ?>" class="btn-small edit">Editar</a>
                ...
                <form action="delete_car.php" method="post" style="display:inline" onsubmit="return confirm('Tem certeza que deseja excluir este carro?')">
                  ...
                  <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token']) ?>">
                  <button type="submit" class="btn-small delete">Excluir</button>
                </form>
              </td>
            </tr>
          <?php endforeach; ?>
